...
const ARTISTS = [
  { id: 'roddo',  name: 'Young Roddo', tag: 'Nairobi · Hip-Hop', img: 'https://i.scdn.co/image/ab67616d00001e02be13539e1883f85f9af81e7e', fallback: 'YR',  color: '#C8960E', real: true,  tilt: -3 },
    ...
    <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', padding: 'clamp(14px,3vh,24px) 16px', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        >
          ...
          <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 12 }}>Tap Young Roddo to start the story</p>
        </motion.div>
